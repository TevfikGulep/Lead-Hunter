...
window.FilterBar = ({ filters, setFilters, selectedCount, setShowBulkModal, activeTab, fixAllTrafficData, onBulkCheck, isCheckingBulk }) => (
    <div className="flex flex-wrap items-center gap-3 mb-4 bg-white p-3 rounded-xl border border-slate-200 shadow-sm">
        ...
        {selectedCount > 0 && (
            <div className="ml-auto flex gap-2 animate-in fade-in">
                <button 
                    onClick={onBulkCheck} 
