...
const LeadHunter = () => {
    ...
    return (
        <div className="flex h-screen bg-slate-50 font-sans text-slate-800 overflow-hidden">
                ...
                <div className="w-full mx-auto p-6 md:p-8">
                    ...
                    {auth.activeTab === 'settings' && (
                        <window.SettingsTab
                            ...
                            autoHunterLogs={services.autoHunterLogs}
            ...
            {services.showEnrichModal && <window.EnrichModal isEnriching={services.isEnriching} enrichProgress={services.enrichProgress} enrichLogs={services.enrichLogs} close={() => services.setShowEnrichModal(false)} stopEnrichBackground={services.stopEnrichBackground} />}
